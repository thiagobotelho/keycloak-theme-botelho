...
node --check "$ROOT_DIR/src/main/resources/theme/botelho/login/resources/js/brand-1.2.0.js"
...
for required in \
  ...
  src/main/resources/theme/botelho/login/resources/css/brand-1.2.0.css \
  src/main/resources/theme/botelho/login/resources/js/brand-1.2.0.js \
  src/main/resources/theme/botelho/admin/theme.properties \
  src/main/resources/theme/botelho/admin/resources/css/admin-1.2.0.css; do

...
if command -v node >/dev/null 2>&1; then
  node --check "$ROOT_DIR/src/main/resources/theme/botelho/login/resources/js/brand-1.2.4.js"
else
...
for required in \
  ...
  src/main/resources/theme/botelho/login/resources/css/brand-1.2.4.css \
  src/main/resources/theme/botelho/login/resources/js/brand-1.2.4.js \
